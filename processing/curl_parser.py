...
class CurlParser:
    ...
    def parse(self, curl_command: str) -> CurlRequest:
        ...
        # Parse data/body
        request.data, request.json_data, request.form_data = self._extract_data(curl_command)
    ...
    def _extract_method(self, command: str) -> str:
        ...
        data_patterns = ["--data", "-d ", "--data-raw", "--data-binary", "-F ", "--form"]
    ...
    def _extract_url(self, command: str) -> str:
        ...
        for i, part in enumerate(parts):
            ...
            if part.startswith("http://") or part.startswith("https://") or part.startswith("'http"):
